...
def to_response_model(product: ProductTable, lang: Lang) -> ProductResponse:
    if lang == Lang.MAIN:
...
def get_products(
    ...
    if lang == Lang.ALT1:
        # filter out products and catefgories with missing translations
        products = (
    ...
    return [to_response_model(product, lang) for product in products]
