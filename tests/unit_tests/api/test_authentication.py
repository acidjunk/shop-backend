...
EXCLUDED_ENDPOINTS = [
    ...
    {"path": "/api/shops/last-completed-order/{id}/", "name": "get_last_completed_order", "method": "GET"},
    {"path": "/api/shops/last-pending-order/{id}/", "name": "get_last_pending_order", "method": "GET"},
